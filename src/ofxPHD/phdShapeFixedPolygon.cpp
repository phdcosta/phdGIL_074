...
void phdShapeFixedPolygon::onMouseMoved(ofMouseEventArgs& args) {

}

void phdShapeFixedPolygon::onMousePressed(ofMouseEventArgs& args) {
...
void phdShapeFixedPolygon::onMouseDragged(ofMouseEventArgs& args) {
...
void phdShapeFixedPolygon::onMouseReleased(ofMouseEventArgs& args) {
	if(hitTestInfo.operation == goWidth) {
